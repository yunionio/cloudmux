...
func init() {
	...
	shellutils.R(&ApigatewayListOptions{}, "apigateway-list", "List apigateways", func(cli *huawei.SRegion, args *ApigatewayListOptions) error {
		ret, err := cli.ListApigateway()
		if err != nil {
			return err
		}
