...
func init() {
	...
	shellutils.R(&cloudprovider.SDBInstanceUpdateOptions{}, "dbinstance-update", "Change dbinstance config", func(cli *huawei.SRegion, args *cloudprovider.SDBInstanceUpdateOptions) error {
		return cli.Update(args.ID, *args)
	})
}
