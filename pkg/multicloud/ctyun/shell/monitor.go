...
func init() {
	shellutils.R(&cloudprovider.MetricListOptions{}, "metric-list", "List metrics in a namespace", func(cli *ctyun.SRegion, args *cloudprovider.MetricListOptions) error {
