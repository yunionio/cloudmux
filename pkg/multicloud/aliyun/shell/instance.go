...
func init() {
	...
	shellutils.R(&InstanceOperationOptions{}, "instance-modification-types", "Get instance available modification types", func(cli *aliyun.SRegion, args *InstanceOperationOptions) error {
