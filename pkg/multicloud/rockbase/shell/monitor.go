...
func init() {
	shellutils.R(&cloudprovider.MetricListOptions{}, "metric-list", "List metrics", func(cli *rockbase.SRegion, args *cloudprovider.MetricListOptions) error {
