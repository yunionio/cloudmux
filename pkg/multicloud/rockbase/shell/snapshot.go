...
func init() {
	...
	shellutils.R(&SnapshotListOptions{}, "snapshot-list", "List snapshot", func(cli *rockbase.SRegion, args *SnapshotListOptions) error {
	...
	shellutils.R(&SnapshotDeleteOptions{}, "snapshot-delete", "Delete snapshot", func(cli *rockbase.SRegion, args *SnapshotDeleteOptions) error {
	...
	shellutils.R(&SnapshotCreateOptions{}, "snapshot-create", "Create snapshot", func(cli *rockbase.SRegion, args *SnapshotCreateOptions) error {
