...
func init() {
	...
	shellutils.R(&EipListOptions{}, "eip-list", "List eips", func(cli *rockbase.SRegion, args *EipListOptions) error {
		eips, e := cli.GetIEips()
		if e != nil {
			return e
		}
	...
	shellutils.R(&EipReleaseOptions{}, "eip-delete", "Release an EIP", func(cli *rockbase.SRegion, args *EipReleaseOptions) error {
	...
	shellutils.R(&EipAssociateOptions{}, "eip-associate", "Associate an EIP", func(cli *rockbase.SRegion, args *EipAssociateOptions) error {
		err := cli.AssociateEip(args.ID, args.INSTANCE)
		return err
	})
	shellutils.R(&EipAssociateOptions{}, "eip-dissociate", "Dissociate an EIP", func(cli *rockbase.SRegion, args *EipAssociateOptions) error {
