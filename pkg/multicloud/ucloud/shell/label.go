...
func init() {
	...
	shellutils.R(&TagGetOptions{}, "tag-show", "Show tags of resources", func(cli *ucloud.SRegion, args *TagGetOptions) error {
	...
	shellutils.R(&TagSetOptions{}, "tag-set", "Set tags of a resource", func(cli *ucloud.SRegion, args *TagSetOptions) error {
