...
func init() {
	...
	shellutils.R(&InstanceOperationOptions{}, "instance-vnc", "Get instance VNC info", func(cli *ucloud.SRegion, args *InstanceOperationOptions) error {
	...
	*/
	...
	shellutils.R(&InstanceSaveImageOptions{}, "instance-save-image", "Save instance to image", func(cli *ucloud.SRegion, args *InstanceSaveImageOptions) error {
