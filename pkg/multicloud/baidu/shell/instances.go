...
func init() {
	...
	shellutils.R(&InstanceListOptions{}, "instance-list", "list instances", func(cli *baidu.SRegion, args *InstanceListOptions) error {
	...
	shellutils.R(&InstanceShowOptions{}, "instance-show", "show instance", func(cli *baidu.SRegion, args *InstanceShowOptions) error {
		res, err := cli.GetInstance(args.ID)
		if err != nil {
